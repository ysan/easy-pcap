...
#include "com_jnistudy_cap_CapJni.h"
...
/*
 * Class:     com_jnistudy_cap_CapJni
 * Method:    nativeInit
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_jnistudy_cap_CapJni_nativeInit
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_jnistudy_cap_CapJni_nativeFin
  (JNIEnv *env, jobject thiz)
{
	std::lock_guard<std::mutex> lock (g_mutex);
 ...
 */
JNIEXPORT void JNICALL Java_com_jnistudy_cap_CapJni_nativeSetInterface
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_jnistudy_cap_CapJni_nativeSetFilter
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_jnistudy_cap_CapJni_nativeClearFilter
  (JNIEnv *env, jobject thiz)
{
	std::lock_guard<std::mutex> lock (g_mutex);
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_jnistudy_cap_CapJni_nativeStart
  (JNIEnv *env, jobject thiz)
{
	std::lock_guard<std::mutex> lock (g_mutex);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_jnistudy_cap_CapJni_nativeStop
  (JNIEnv *env, jobject thiz)
{
	std::lock_guard<std::mutex> lock (g_mutex);
 ...
 * Signature: (Lcom/jnistudy/cap/IPacketListener;)I
 */
JNIEXPORT jint JNICALL Java_com_jnistudy_cap_CapJni_nativeRegisterPacketListener
 ...
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_com_jnistudy_cap_CapJni_nativeUnregisterPacketListener
 ...
 */
JNIEXPORT jint JNICALL Java_com_jnistudy_cap_CapJni_nativeGetInterfaceList
  (JNIEnv * env, jobject thiz, jobject outList)
{
	...
	jint num = 0;
	jclass cl_interface = env->FindClass ("com/jnistudy/cap/Interface");
